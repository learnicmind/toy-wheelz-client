...
const Header = () => {
    ...
    const navItems = <>
        ...
        <li><Link to='/alltoys' className="text-lg font-bold" >All Toys</Link></li>
        <li><Link to='/mytoys' className="text-lg font-bold" >My Toys</Link></li>
        <li><Link to='/addtoy' className="text-lg font-bold" >Add a Toy</Link></li>
