            ...
            <div className="mx-auto md:w-[1300px] text-gray-700">
                <div className="navbar py-4">
                    ...
                    <div className="navbar-end flex items-center gap-2">
                        <img className="w-10 rounded-full" src="https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=740&t=st=1684436550~exp=1684437150~hmac=2dde41d83a7c88b827e4d287b54cb75a292f4c2c894a0339ea2762cbc4244922" />
                        <button className="btn bg-slate-950">Logout</button>
                        <button className="btn bg-slate-950">Login</button>
                    </div>
                </div>
            </div>
        </div>
